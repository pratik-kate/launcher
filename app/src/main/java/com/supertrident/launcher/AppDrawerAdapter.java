...
public class AppDrawerAdapter extends RecyclerView.Adapter<AppDrawerAdapter.ViewHolder> {
    ...
    @Override
    public void onBindViewHolder(AppDrawerAdapter.ViewHolder viewHolder, int i) {
    ...
    @Override
    public AppDrawerAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
